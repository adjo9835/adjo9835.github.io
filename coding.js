function display2_1() {
  var myanswer  = "Undefined, true, false.  A null character has the same type as undefined.  On the third line there is a extra equals sign, therefore, the comparison  between null and nudefined must be exact for this statement to return true." // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "The code will throw a console error because x must be declared before being assigned to a value.  Without 'use strict,' there will be no error and nothing shown in the console." // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "I don't see any children that I am not already able to see by viewing the HTML file" // TODO 2.5: Fill in Answer here
...
function countDiv() { // Do not add or remove lines to this function
    var divs = document.getElementsByClassName('div'); // TODO: Question 2.3: Use the document Object to get the number of divs in the HTML page. Replace dummyMethod with the correct one.
